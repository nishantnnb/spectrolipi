...
(function(){
  ...
  modal.innerHTML = (
    '<div id="normalizeHeader" style="cursor:grab; user-select:none; margin:-12px -12px 12px -12px; padding:12px; background:#1a1a1a; border-radius:8px 8px 0 0; border-bottom:1px solid rgba(255,255,255,0.06);"><h3 id="normalizeTitle" style="margin:0;font-size:1rem">Normalize</h3></div>' +
  ...
  const header = document.getElementById('normalizeHeader');
  ...
  if (header) {
    ...
    header.addEventListener('pointermove', (e) => {
      ...
      modal.style.left = (e.clientX - dragOffX + modal.offsetWidth / 2) + 'px';
      modal.style.top = (e.clientY - dragOffY + modal.offsetHeight / 2) + 'px';
    });
