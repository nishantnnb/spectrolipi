  ...
  window.addEventListener('keydown', (ev) => {
    try {
      ...
      if (isSpace) {
        ...
        let selectedCount = 0;
        try {
          if (window.annotationGrid && window.annotationGrid.initialized && typeof window.annotationGrid.getSelectedData === "function") {
            selectedCount = window.annotationGrid.getSelectedData().length;
          }
        } catch (e) {}
